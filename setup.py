...
def load_long_description():
    # url = os.path.join("https://github.com/FootBrawlers/game_play", 'raw', , 'docs')
...
setup(
    name='game_play',
    version="0.1.0",
    description="Dynamic Path Navigation for Robots",
    author="Aditya Oke",
    author_email="RoboSoccerVIT@gmail.com",
    # url=pl_bolts.__homepage__,
    download_url="https://github.com/FootBrawlers/game_play",
    license="apache2",
    ...
    project_urls={
        "Bug Tracker": "https://github.com/FootBrawlers/game_play/issues",
        "Documentation": "https://quick-ai.github.io/quickvision/",
        "Source Code": "https://github.com/FootBrawlers/game_play",
    },
